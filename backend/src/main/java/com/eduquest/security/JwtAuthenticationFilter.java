...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtTokenProvider tokenProvider, UserAccountRepository userAccountRepository) {
        ...
        if (StringUtils.hasText(jwt) && tokenProvider.validateToken(jwt)) {
            ...
            userAccountRepository.findByUsername(username).ifPresent(userAccount -> {
                ...
                UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(
                        userAccount, null, Collections.singletonList(authority));
